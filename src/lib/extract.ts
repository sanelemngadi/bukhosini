import { SprotDocumentPremites, SprotEntity, SprotLayer, SprotPoint, SprotSize, type SprotEntityKind } from "$wasm/sprot_app";
...
//     active: boolean,
// }
// export interface SprotEntity {
//     id: number,
//     kind: SprotEntityKind,
//     layer: number, 
//     theme: ITheme,
//     rfPoint: IPoint,
//     size: ISize,
...
// export enum ISprotDocPremitives {
//     // Grid = 8, for survey  -x, y (top, right)
//     Constants = 9,
//     Colors = 10,
//     Layers,
//     Surface,
...
// 9,space[20000.00:3325500.00:302.0],;10,1,22523,;10,2,ff256,;10,3,dd4dd2,;10,4,aadf,;10,5,ffdaa,;11,1,Buildings,theme[-2:-4],2,0,;11,2,Fence,theme[-10:-24],2,0,;11,3,Tank,theme[-250:-14],2,0,;11,4,Top_Kurb,theme[-14:-20,],2,1,;12,1,Sanele,-14,;12,2,Ntuso,-21,;12,3,Sisanda,-14,;12,4,Londeka,-132,;13,12,123,A1,space[2025.32:325325.23:256.32],SS,;13,12,124,A1,space[2025.32:325325.23:256.32],SS,;
// 13,12,125,A3,space[2025.32:325325.23:256.32],TB,;
// 13,12,140,A4,space[2025.32:325325.23:256.32],TB,;
// 13,24,141,A5,space[2025.32:325325.23:256.32],SS,;
// 13,12,142,A6,space[2025.32:325325.23:256.32],SS,;13,23,143,A7,space[2025.32:325325.23:256.32],SS,;13,24,144,A8,space[2025.32:325325.23:256.32],SS,;13,24,145,A9,space[2025.32:325325.23:256.32],SS,;13,24,146,B1,space[2025.32:325325.23:256.32],SS,;13,24,147,B2,space[2025.32:325325.23:256.32],SS,;13,24,148,B3,space[2025.32:325325.23:256.32],SS,;13,14,149,B4,space[2025.32:325325.23:256.32],SS,;13,23,150,B5,space[2025.32:325325.23:256.32],SS,;13,24,151,B6,space[2025.32:325325.23:256.32],TB,;13,24,156,B7,space[2025.32:325325.23:256.32],TB,;13,24,157,B8,space[2025.32:325325.23:256.32],TB,;13,24,158,B9,space[2025.32:325325.23:256.32],TB,;14,20,1,100,theme[-10:-10],space[2025.32:325325.23:256.32],geom[240.0:230.0],1,;14,25,2,102,theme[-10:-20],space[2025.32:325325.23:2514.25],geom[240.0:230.0],9,points[space[2025.32:325325.23:256.32]|space[2025.32:325325.23:256.32]|space[2025.32:325325.23:256.32]|space[2025.32:325325.23:256.32]],;
// `
...
const resolve = (value: IFix | SprotEntity | SprotLayer | ISurface | IPoint | ICustomColor): 
    Promise<IFix | SprotEntity | SprotLayer | ISurface | IPoint | ICustomColor> => {
    return Promise.resolve(value);
}

const reject_size = (): Promise<IFix | SprotEntity | SprotLayer | ISurface | IPoint | ICustomColor> => {
...
export class SprotExtractionUtil {
    ...
    private extactEntity = (items: string[]): SprotEntity => {
        ...
        let entity = SprotEntity.from_client(
