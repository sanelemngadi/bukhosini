...
//   import Plus from "$components/icons/Plus.svelte";
    ...
    import { NO_SELECTION, type ISprotPropertyAttribute, type SprotTSSelection } from "$lib/types";
...
<div class="relative h-full overflow-hidden flex flex-col">
    <div class="">
        <div class="flex items-center justify-between px-2 pt-2">
            ...
            <button class="underline underline-offset-2 cursor-pointer">Target</button>
        </div>
