<script lang="ts">
  ...
  import type { ComponentType } from "svelte";
    ...
    <button 
        class="flex h-6 w-full hover:bg-sprotPrimary font-normal items-center whitespace-nowrap justify-between gap-4 px-2 text-[11.5px] {disabled ? "text-[gray]" : "text-sprotText"}"
    ...
    <span  
        ...
        <span class="inline-flex items-center gap-2 flex-1">
            <svelte:component this={icon} size={16} color="{disabled ? "rgba(255,255,255, 0.15)" : "white"}" />
